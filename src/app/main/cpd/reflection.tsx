...
const Reflection = (props) => {
    ...
    let allReflections = cpdPlanningData.data?.flatMap(item => item?.reflections ? item.reflections : []);
    const paginatedData = allReflections.slice((page - 1) * rowsPerPage, page * rowsPerPage);
