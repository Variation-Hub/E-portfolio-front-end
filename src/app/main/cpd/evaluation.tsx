...
import { createEvaluationAPI, deleteEvaluationHandler, getCpdPlanningAPI, selectCpdPlanning, slice, updateEvaluationAPI, uploadImages } from "app/store/cpdPlanning";
...
const AddNewEvaluationDialogContent = (props) => {
    ...
    const { edit = "Save", formData, setEvaluationData, evaluationData = {}, handleChangeYear } = props;
