          ...
          <div className="p-10" key={item.path}>
            <Tooltip title={item.info} placement="bottom" arrow>
              <Link to={item.path} style={{ textDecoration: 'none' }}>
                <Paper
                  elevation={3}
                  className="rounded-sm p-56 w-full md:w-4/5 lg:w-3/5 h-96 mx-auto my-0 flex flex-col items-center justify-center"
                >
                  <img
                    src={item.svg}
                    alt="Img"
                    className="w-full h-auto md:w-2/3 lg:w-1/2 max-w-xl mx-auto mb-4"
                  />
