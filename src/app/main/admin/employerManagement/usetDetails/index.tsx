...
const UserDetails = (props) => {
    ...
    return (
        <div>
            <Breadcrumb linkData={[AdminRedirect, EmployerRedirect]} currPage="Create Employer" />
                        ...
                        <Box>
                            ...
                            <Box className="m-12 flex flex-col justify-between gap-12 sm:flex-row">
                                <div className='w-full'>
                                    <Typography sx={{ fontSize: "0.9vw", marginBottom: "0.5rem", fontWeight: "500" }}>Choose resource for course</Typography>
