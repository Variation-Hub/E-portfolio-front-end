...
// create cpd planning
export const createCpdPlanningAPI = (data) => async (dispatch) => {
    try {
...
// update cpd planning
export const updateCpdPlanningAPI = (data) => async (dispatch) => {
    try {
...
// create cpd Activity
export const createActivityAPI = (data) => async (dispatch) => {
    try {
        dispatch(slice.setUpdatingLoader());
...
// update cpd Activity
export const updateActivityAPI = (id, data) => async (dispatch) => {
    try {
...
// delete cpd Activity
export const deleteActivityHandler = (id) => async (dispatch) => {
    try {
        dispatch(slice.setUpdatingLoader());
...
export const createEvaluationAPI = (data) => async (dispatch) => {
    try {
        dispatch(slice.setUpdatingLoader());
...
export const updateEvaluationAPI = (id, data) => async (dispatch) => {
    try {
...
export const deleteEvaluationHandler = (id) => async (dispatch) => {
    try {
        dispatch(slice.setUpdatingLoader());
...
export const createReflectionAPI = (data) => async (dispatch) => {
    try {
        dispatch(slice.setUpdatingLoader());
...
export const updateReflectionsAPI = (id, data) => async (dispatch) => {
    try {
...
export const deleteReflectionHandler = (id) => async (dispatch) => {
    try {
        dispatch(slice.setUpdatingLoader());
...
export const getCpdPlanningAPI = (id) => async (dispatch) => {

    try {

        dispatch(slice.setLoader());

        let url = `${URL_BASE_LINK}/cpd/get/${id}?table=activities,evaluations,reflections`
