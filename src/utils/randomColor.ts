...
export const mobileCodes = [
  ...
  { code: 'CV', name: 'Cabo Verde', dialingCode: '+238' },
  ...
  { code: 'CD', name: 'Congo (DRC)', dialingCode: '+243' },
  { code: 'CG', name: 'Congo (Republic)', dialingCode: '+242' },
  ...
  { code: 'ST', name: 'São Tomé and Príncipe', dialingCode: '+239' },
